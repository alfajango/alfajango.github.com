...
You get the picture. EasyTabs just leaves the styling up to you, and
doesn't mangle your HTML markup. Basically, it handles the functionality
while staying out of your way.

Why you should use EasyTabs, in list format:
...
<div id="twitter-bootstrap-tabs">
 <ul class="tabs">
  <li class="active"><a href="#twitter-home">Home</a></li>
 ...
 <div class="panels">
  <div id="twitter-home">
   <p>Works out of the box with Twitter Bootstrap styles.</p>
  </div>
...
<div id="jqueryui-tabs">
 ...
 <div id="jqueryui-tabs-1">
  <p>EasyTabs can be used with your existing jQuery UI theme as well.
